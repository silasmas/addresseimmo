...
@section('app-content')
    ...
    @if (request()->get('check') == 'phone')
                            <i class="bi bi-telephone mx-3 text-danger" style="font-size: 5rem;"></i>
    @else
                            <i class="bi bi-envelope-open mx-3 text-danger" style="font-size: 5rem;"></i>
    @endif
    ...
    @else
        ...
        @if (request()->get('check') == 'phone')
                                    <span style="display: inline-block; margin-left: 20px;"><a href="{{ route('password.request') }}">@lang('auth.verify-email')</a> <i class="bi bi-chevron-double-right" style="vertical-align: -1px;"></i></span>
        @else
                                    <span style="display: inline-block; margin-left: 20px;"><a href="{{ route('password.request', ['check' => 'phone']) }}">@lang('auth.verify-phone')</a> <i class="bi bi-chevron-double-right" style="vertical-align: -1px;"></i></span>
        @endif
                                </div>
    @endif
                            </div>
