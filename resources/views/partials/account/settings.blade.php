...
@csrf
                                <div class="row g-3">
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="text" name="firstname" class="form-control @error('firstname') is-invalid @enderror" id="firstname" value="{{ $current_user['firstname'] }}" autofocus>
@error('firstname')
...
@enderror
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="text" name="lastname" class="form-control" id="lastname" value="{{ $current_user['lastname'] }}">
                                    </div>

                                    <div class="col-lg-4 col-sm-6">
                                        <label for="surname" class="form-label fw-bold">Post-nom</label>
                                        <input type="text" name="surname" class="form-control" id="surname" value="{{ $current_user['surname'] }}">
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="text" name="birthdate" class="form-control" id="birthdate" value="{{ !empty($current_user['birthdate']) ? explode('-', $current_user['birthdate'])[2] . '/' . explode('-', $current_user['birthdate'])[1] . '/' . explode('-', $current_user['birthdate'])[0] : '' }}">
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ $current_user['email'] }}">
@error('email')
                                        <small class="text-danger d-inline-block mt-1 float-end">{{ $message }}</small>
@enderror
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="phone" value="{{ $current_user['phone'] }}">
                                    </div>

                                    <div class="col-lg-4 col-sm-6">
                                        <label for="username" class="form-label fw-bold">Nom d’utilisateur</label>
                                        <input type="text" name="username" class="form-control" id="username" value="{{ $current_user['username'] }}">
                                    </div>
                                </div>
